...
# If use extra BN for unsupervised pre-traind model
_C.MODEL.BACKBONE.EXTRA_BN = False
...
# If dataset in LMDB format
_C.DATASETS.IS_LMDB = False
...
_C.SOLVER.BACKBONE_BN_LR_FACTOR = 1.
